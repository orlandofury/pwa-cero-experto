...
/**
 * Demo de como funcionan las API de notificaciones
 */
function enviarNotificacion(){
    ...
    const n = new Notification('Hola mundo con opts!!', notificationOpts);
    n.onclick = () => {
        console.log('Click');
    }
}
